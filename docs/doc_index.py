...
search_formulae_dcgpy_v3_custom(myproblem = None, pars_dict:dict = None, verbose = False, )
...
myProblem2.get_cost(self, expr:None, symbols)
myProblem2.rank_score(self, fornulae_str:str)
