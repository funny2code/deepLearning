...
help()
metrics_cosinus_similarity(emb_list1 = None, emb_list2 = None, name_list = None)
...
np_array_to_str(vv, )
np_cosinus_most_similar(embv  =  None, emb_name_list = None)
np_matrix_to_str(m)
...
NERExtractor.extractTriples(self, max_text:int, return_val = False)
NERExtractor.extract_entities(self, sents:List[str])
NERExtractor.obtain_relation(self, sent)
knowledge_grapher.__init__(self, data_kgf:pd.DataFrame, embedding_dim:int = 14, dirin:str = "./mydatain/", dirout:str = "./mydataout/", )
